...
ms:mtpsurl: https://technet.microsoft.com/de-de/library/Gg398128(v=OCS.15)
ms:contentKeyID: 49293073
ms.date: 05/19/2016
...
Returns information regarding media settings, including the supported level of encryption, whether Siren can be used as a voice codec by the Vermittlungsserver in its interactions with Lync Server clients, and the maximum allowed video resolution. Dieses Cmdlet wurde in Lync Server 2010 eingeführt.
...
<td><p>Retrieves the media configuration information from the local replica of the zentralen Verwaltungsspeicher, rather than from the zentralen Verwaltungsspeicher itself.</p></td>
</tr>
</tbody>
</table>
