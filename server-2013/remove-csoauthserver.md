...
ms:mtpsurl: https://technet.microsoft.com/de-de/library/JJ205408(v=OCS.15)
ms:contentKeyID: 49295977
ms.date: 05/19/2016
...
Removes an existing Open Authorization (OAuth) server. OAuth servers, also known as security token servers, issue security tokens used in server-to-server authentication and authorization. Dieses Cmdlet wurde in Lync Server 2013 eingeführt.
...
**Lync Server-Systemsteuerung:** The functions carried out by the **Remove-CsOAuthServer** cmdlet are not available in the Lync Server-Systemsteuerung.
