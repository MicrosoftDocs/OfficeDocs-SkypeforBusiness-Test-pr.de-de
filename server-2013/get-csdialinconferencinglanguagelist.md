...
ms:mtpsurl: https://technet.microsoft.com/de-de/library/Gg425869(v=OCS.15)
ms:contentKeyID: 49293707
ms.date: 05/19/2016
...
Returns a list of languages, including regional/minority languages, supported for use with Lync Server dial-in conferences. These languages are used to relay audio messages and instructions to users participating in a conference by using a telephone. Dieses Cmdlet wurde in Lync Server 2010 eingeführt.
...
<td><p>Retrieves the languages list from the local replica of the zentralen Verwaltungsspeicher rather than from the zentralen Verwaltungsspeicher itself.</p></td>
</tr>
</tbody>
</table>
