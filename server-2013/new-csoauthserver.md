...
ms:mtpsurl: https://technet.microsoft.com/de-de/library/JJ205206(v=OCS.15)
ms:contentKeyID: 49295206
ms.date: 05/19/2016
...
Creates a new Open Authorization (OAuth) server for use by the organization. OAuth servers, also known as security token servers, issue security tokens used in server-to-server authentication and authorization. Dieses Cmdlet wurde in Lync Server 2013 eingeführt.
...
**Lync Server-Systemsteuerung:** The functions carried out by the New-CsOAuthServer cmdlet are not available in the Lync Server-Systemsteuerung.
