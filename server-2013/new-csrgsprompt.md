...
ms:mtpsurl: https://technet.microsoft.com/de-de/library/Gg398486(v=OCS.15)
ms:contentKeyID: 49294268
ms.date: 05/19/2016
...
Creates a new workflow prompt for the Reaktionsgruppenanwendung. A workflow prompt is either an audio file that is played or text that is read aloud in order to supply callers with additional information. Dieses Cmdlet wurde in Lync Server 2010 eingeführt.
