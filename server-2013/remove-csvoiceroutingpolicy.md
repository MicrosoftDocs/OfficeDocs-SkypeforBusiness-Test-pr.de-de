...
ms:mtpsurl: https://technet.microsoft.com/de-de/library/JJ204799(v=OCS.15)
ms:contentKeyID: 49293665
ms.date: 05/19/2016
...
**Lync Server-Systemsteuerung:** The functions carried out by the **Remove-CsVoiceRoutingPolicy** cmdlet are not available in the Lync Server-Systemsteuerung.
