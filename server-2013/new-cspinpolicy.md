...
ms:mtpsurl: https://technet.microsoft.com/de-de/library/Gg398935(v=OCS.15)
ms:contentKeyID: 49295547
ms.date: 05/19/2016
...
Creates a new client personal identification number (PIN) policy. PIN authentication enables users to access Lync Server by providing a PIN instead of a user name and password. Dieses Cmdlet wurde in Lync Server 2010 eingeführt.
