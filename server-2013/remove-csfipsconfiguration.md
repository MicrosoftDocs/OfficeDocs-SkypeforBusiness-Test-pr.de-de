...
ms:mtpsurl: https://technet.microsoft.com/de-de/library/JJ205201(v=OCS.15)
ms:contentKeyID: 49295187
ms.date: 05/19/2016
...
**Lync Server-Systemsteuerung:** The functions carried out by the Remove-CsFIPSConfiguration cmdlet are not available in the Lync Server-Systemsteuerung.
