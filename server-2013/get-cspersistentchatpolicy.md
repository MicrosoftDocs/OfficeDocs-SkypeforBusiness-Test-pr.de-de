...
ms:mtpsurl: https://technet.microsoft.com/de-de/library/JJ204673(v=OCS.15)
ms:contentKeyID: 49293189
ms.date: 05/19/2016
...
Returns information about the Persistent Chat policies configured for use in your organization. Persistent Chat policies determine whether or not users are allowed access to Persistent Chat chat rooms. Dieses Cmdlet wurde in Lync Server 2013 eingeführt.
...
**Lync Server-Systemsteuerung:** To view Persistent Chat policy information in the Lync Server-Systemsteuerung, click **Persistent Chat** and then click **Persistent Chat Policy**.
