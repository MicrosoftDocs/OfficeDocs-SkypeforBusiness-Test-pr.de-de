...
ms:mtpsurl: https://technet.microsoft.com/de-de/library/Gg425858(v=OCS.15)
ms:contentKeyID: 49293690
ms.date: 05/19/2016
...
Creates an object reference to the default certificate used by Lync Server. This object reference can then be used to configure a static route to use Transport Layer Security (TLS) as its transport protocol. Dieses Cmdlet wurde in Lync Server 2010 eingeführt.
