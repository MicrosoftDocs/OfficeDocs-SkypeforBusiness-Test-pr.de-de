...
ms:mtpsurl: https://technet.microsoft.com/de-de/library/JJ204636(v=OCS.15)
ms:contentKeyID: 49293019
ms.date: 05/19/2016
...
**Lync Server-Systemsteuerung:** The functions carried out by the **Get-CsEffectivePolicy** cmdlet are not directly available in the Lync Server-Systemsteuerung.
