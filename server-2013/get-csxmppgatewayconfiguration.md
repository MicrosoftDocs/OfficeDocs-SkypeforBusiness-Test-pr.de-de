...
ms:mtpsurl: https://technet.microsoft.com/de-de/library/JJ204869(v=OCS.15)
ms:contentKeyID: 49293938
ms.date: 05/19/2016
...
Returns information about the XMPP gateway configuration settings in use in the organization. The extensible Messaging and Presence Protocol (XMPP) is an open-standard communications protocol for exchanging messages using XML. XMPP gateways enable Lync Server 2013 users to exchange instant message and presence information with users belonging to IM and presence providers that employ XMPP. Dieses Cmdlet wurde in Lync Server 2013 eingeführt.
...
**Lync Server-Systemsteuerung:** The functions carried out by the **Get-CsXmppGatewayConfiguration** cmdlet are not available in the Lync Server-Systemsteuerung.
