...
ms:mtpsurl: https://technet.microsoft.com/de-de/library/JJ205247(v=OCS.15)
ms:contentKeyID: 49295343
ms.date: 05/19/2016
...
Manually purges records from the Quality of Experience (QoE) database. Dieses Cmdlet wurde in Lync Server 2013 eingeführt.
...
**Lync Server-Systemsteuerung:** The functions carried out by the **Invoke-CsQoEDatabasePurge** cmdlet are not available in the Lync Server-Systemsteuerung.
