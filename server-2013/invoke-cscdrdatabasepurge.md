...
ms:mtpsurl: https://technet.microsoft.com/de-de/library/JJ205113(v=OCS.15)
ms:contentKeyID: 49294809
ms.date: 05/19/2016
...
Manually purges records from the Call Detail records (CDR) database. Dieses Cmdlet wurde in Lync Server 2013 eingeführt.
...
**Lync Server-Systemsteuerung:** The functions carried out by the **Invoke-CsCdrDatabasePurge** cmdlet are not available in the Lync Server-Systemsteuerung.
