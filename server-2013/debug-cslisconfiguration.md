...
ms:mtpsurl: https://technet.microsoft.com/de-de/library/Gg398710(v=OCS.15)
ms:contentKeyID: 49294695
ms.date: 05/19/2016
...
Displays the Enhanced 9-1-1 (E9-1-1) Location Information service (LIS) configuration in XML format. Dieses Cmdlet wurde in Lync Server 2010 eingeführt.
...
This cmdlet retrieves the location information from the zentralen Verwaltungsspeicher. When this information is created, it is stored in the location database; it does not move to the zentralen Verwaltungsspeicher until it is published with the **Publish-CsLisConfiguration** cmdlet. If the location information has not been published (or has been un-published with the **Unpublish-CsLisConfiguration** cmdlet), the **Debug-CsLisConfiguration** cmdlet will not return anything.
