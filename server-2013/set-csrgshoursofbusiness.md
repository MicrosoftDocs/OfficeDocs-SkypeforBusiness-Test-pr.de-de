...
ms:mtpsurl: https://technet.microsoft.com/de-de/library/Gg412929(v=OCS.15)
ms:contentKeyID: 49295260
ms.date: 05/19/2016
...
Configures an existing set of Response Group business hours. Business hour sets are used to indicate the days of the week and the times of day when Response Group agents are typically available to answer phone calls. Dieses Cmdlet wurde in Lync Server 2010 eingeführt.
