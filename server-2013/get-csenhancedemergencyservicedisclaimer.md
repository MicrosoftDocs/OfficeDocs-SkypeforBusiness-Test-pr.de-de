...
ms:mtpsurl: https://technet.microsoft.com/de-de/library/Gg412877(v=OCS.15)
ms:contentKeyID: 49295165
ms.date: 05/19/2016
...
Retrieves the disclaimer text that is used globally to prompt for location information for an Enhanced 9-1-1 (E9-1-1) implementation. Dieses Cmdlet wurde in Lync Server 2010 eingeführt.
...
<td><p>Retrieves the disclaimer information from the local replica of the zentralen Verwaltungsspeicher, rather than the zentralen Verwaltungsspeicher itself.</p></td>
</tr>
</tbody>
</table>
