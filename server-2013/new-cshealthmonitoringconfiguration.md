...
ms:mtpsurl: https://technet.microsoft.com/de-de/library/Gg398718(v=OCS.15)
ms:contentKeyID: 49294717
ms.date: 05/19/2016
...
Creates a new collection of health monitoring configuration settings for use in your organization. These settings enable administrators to run quality assurance tests without having to supply the user names and passwords for the required test accounts. Dieses Cmdlet wurde in Lync Server 2010 eingeführt.
