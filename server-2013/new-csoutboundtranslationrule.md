...
ms:mtpsurl: https://technet.microsoft.com/de-de/library/Gg412803(v=OCS.15)
ms:contentKeyID: 49295040
ms.date: 05/19/2016
...
Creates a new outbound translation rule. An outbound translation rule converts phone numbers to the local dialing format for interaction with private branch exchange (PBX) systems. Dieses Cmdlet wurde in Lync Server 2010 eingeführt.
