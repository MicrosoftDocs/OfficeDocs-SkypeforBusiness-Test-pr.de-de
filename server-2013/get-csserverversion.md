...
ms:mtpsurl: https://technet.microsoft.com/de-de/library/Gg398470(v=OCS.15)
ms:contentKeyID: 49294244
ms.date: 05/19/2016
...
Returns server licensing information for a computer running Lync Server. Dieses Cmdlet wurde in Lync Server 2010 eingeführt.
...
That no license key is required for the components installed on the local computer. (Licensing is required only for computers functioning as a Front-End-Server, a Director, or an Edgeserver.)
