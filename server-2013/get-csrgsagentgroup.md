...
ms:mtpsurl: https://technet.microsoft.com/de-de/library/Gg425793(v=OCS.15)
ms:contentKeyID: 49293542
ms.date: 05/19/2016
...
Returns information about the Response Group agent groups configured for use in your organization. An agent group is a collection of agents assigned to a Response Group queue. Agents are the users assigned to answer calls directed to a queue. Dieses Cmdlet wurde in Lync Server 2010 eingeführt.
