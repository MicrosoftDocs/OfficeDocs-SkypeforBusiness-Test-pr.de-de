...
ms:mtpsurl: https://technet.microsoft.com/de-de/library/Gg398209(v=OCS.15)
ms:contentKeyID: 49293245
ms.date: 05/19/2016
...
Removes an existing range of unassigned numbers and the routing rules that apply to those numbers. Dieses Cmdlet wurde in Lync Server 2010 eingeführt.
