...
ms:mtpsurl: https://technet.microsoft.com/de-de/library/Gg398728(v=OCS.15)
ms:contentKeyID: 49294735
ms.date: 05/19/2016
...
Removes the specified conferencing policy. Conferencing policies determine the features and capabilities that can be used in a conference; this includes everything from whether or not the conference can include IP audio and video to the maximum number of people who can attend a meeting. Dieses Cmdlet wurde in Lync Server 2010 eingeführt.
