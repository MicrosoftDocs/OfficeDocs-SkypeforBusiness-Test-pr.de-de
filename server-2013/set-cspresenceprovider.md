...
ms:mtpsurl: https://technet.microsoft.com/de-de/library/JJ204833(v=OCS.15)
ms:contentKeyID: 49293783
ms.date: 05/19/2016
...
Modifies a presence provider configured for use in the organization. Presence providers represent the PresenceProviders property of a collection of user services configuration settings. Dieses Cmdlet wurde in Lync Server 2013 eingeführt.
...
**Lync Server-Systemsteuerung:** The functions carried out by the **Set-CsPresenceProvider** cmdlet are not available in the Lync Server-Systemsteuerung.
