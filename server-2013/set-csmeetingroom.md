...
ms:mtpsurl: https://technet.microsoft.com/de-de/library/JJ204831(v=OCS.15)
ms:contentKeyID: 49293771
ms.date: 05/19/2016
...
Modifies the property values of an existing Lync Server 2013 meeting room. A meeting room is a conferencing device designed to address video conferencing and collaboration scenarios in small conference rooms. Dieses Cmdlet wurde in Lync Server 2013 eingeführt.
...
Lync Server-Systemsteuerung: The functions carried out by the **Set-CsMeetingRoom** cmdlet are not available in the Lync Server-Systemsteuerung.
