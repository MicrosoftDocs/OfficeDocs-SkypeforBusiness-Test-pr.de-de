...
ms:mtpsurl: https://technet.microsoft.com/de-de/library/Gg398905(v=OCS.15)
ms:contentKeyID: 49295491
ms.date: 05/19/2016
...
Creates a new client version policy rule. Client version policy rules help determine whether users can use a specific client application to log on to Lync Server. Dieses Cmdlet wurde in Lync Server 2010 eingeführt.
