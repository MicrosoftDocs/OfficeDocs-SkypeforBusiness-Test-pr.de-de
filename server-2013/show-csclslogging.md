...
ms:mtpsurl: https://technet.microsoft.com/de-de/library/JJ619173(v=OCS.15)
ms:contentKeyID: 49293324
ms.date: 05/19/2016
...
Shows the current status of the centralized logging service. (That is, shows which centralized logging scenarios are currently active.) Centralized logging provides a way for administrators to simultaneously enable or disable Lync Server 2013 tracing on multiple computers. Dieses Cmdlet wurde in Lync Server 2013 eingeführt.
