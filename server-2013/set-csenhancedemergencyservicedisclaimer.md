...
ms:mtpsurl: https://technet.microsoft.com/de-de/library/Gg398620(v=OCS.15)
ms:contentKeyID: 49294522
ms.date: 05/19/2016
...
Sets disclaimer text that will be used globally to prompt for location information for an Enhanced 9-1-1 (E9-1-1) implementation. Dieses Cmdlet wurde in Lync Server 2010 eingeführt. It has been deprecated for use with Lync Server 2013. For Lync Server 2013, E9-1-1 disclaimers should be configured by using the [New-CsLocationPolicy](new-cslocationpolicy.md) cmdlet and the [Set-CsLocationPolicy](set-cslocationpolicy.md) cmdlet.
