...
ms:mtpsurl: https://technet.microsoft.com/de-de/library/JJ205242(v=OCS.15)
ms:contentKeyID: 49295321
ms.date: 05/19/2016
...
Synchronizes user data between a pair of Lync Server 2013 pools. Dieses Cmdlet wurde in Lync Server 2013 eingeführt.
...
**Lync Server-Systemsteuerung:** The functions carried out by the **Sync-CsUserData** cmdlet are not available in the Lync Server-Systemsteuerung.
