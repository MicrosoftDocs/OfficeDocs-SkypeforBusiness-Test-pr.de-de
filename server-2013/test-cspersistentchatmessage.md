...
ms:mtpsurl: https://technet.microsoft.com/de-de/library/JJ204656(v=OCS.15)
ms:contentKeyID: 49293100
ms.date: 05/19/2016
...
Verifies whether or not a pair of users can exchange messages using the Persistent Chat service (formerly known as the Group Chat service). Dieses Cmdlet wurde in Lync Server 2013 eingeführt.
...
Lync Server-Systemsteuerung: The functions carried out by the **Test-CsPersistentChatMessage** cmdlet are not available in the Lync Server-Systemsteuerung.
