...
ms:mtpsurl: https://technet.microsoft.com/de-de/library/JJ205138(v=OCS.15)
ms:contentKeyID: 49294919
ms.date: 05/19/2016
...
Verifies connectivity through the A/V Edge server. Dieses Cmdlet wurde in Lync Server 2013 eingeführt.
...
**Lync Server-Systemsteuerung:** The functions carried out by the **Test-CsAVEdgeConnectivity** cmdlet are not available in the Lync Server-Systemsteuerung.
