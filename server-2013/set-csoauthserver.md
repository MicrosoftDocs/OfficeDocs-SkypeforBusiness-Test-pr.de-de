...
ms:mtpsurl: https://technet.microsoft.com/de-de/library/JJ204896(v=OCS.15)
ms:contentKeyID: 49294006
ms.date: 05/19/2016
...
Modifies an existing Open Authorization (OAuth) server. OAuth servers, also known as security token servers, issue security tokens used in server-to-server authentication and authorization. Dieses Cmdlet wurde in Lync Server 2013 eingeführt.
...
**Lync Server-Systemsteuerung:** The functions carried out by the **Set-CsOAuthServer** cmdlet are not available in the Lync Server-Systemsteuerung.
