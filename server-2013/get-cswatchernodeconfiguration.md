...
ms:mtpsurl: https://technet.microsoft.com/de-de/library/JJ204739(v=OCS.15)
ms:contentKeyID: 49293402
ms.date: 04/05/2017
...
**Lync Server-Systemsteuerung:** The functions carried out by the **Get-CsWatcherNodeConfiguration** cmdlet are not available in the Lync Server-Systemsteuerung.
