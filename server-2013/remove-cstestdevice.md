...
ms:mtpsurl: https://technet.microsoft.com/de-de/library/Gg398790(v=OCS.15)
ms:contentKeyID: 49294850
ms.date: 05/19/2016
...
Removes the specified device update management test device. Test devices provide a way for administrators to test firmware updates before those updates are distributed to all the devices in an organization. Dieses Cmdlet wurde in Lync Server 2010 eingeführt.
