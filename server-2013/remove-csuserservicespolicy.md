...
ms:mtpsurl: https://technet.microsoft.com/de-de/library/JJ204629(v=OCS.15)
ms:contentKeyID: 49292995
ms.date: 05/19/2016
...
**Lync Server-Systemsteuerung:** The functions carried out by the R**emove-CsUserServicesPolicy** cmdlet are not available in the Lync Server-Systemsteuerung.
