...
ms:mtpsurl: https://technet.microsoft.com/de-de/library/JJ204639(v=OCS.15)
ms:contentKeyID: 49293033
ms.date: 05/19/2016
...
Removes one or more Persistent Chat chat rooms. A chat room is a discussion forum that typically revolves around a specific topic. Dieses Cmdlet wurde in Lync Server 2013 eingeführt.
...
**Lync Server-Systemsteuerung:** To delete an existing Persistent Chat chat room using the Lync Server-Systemsteuerung, click **Persistent Chat**, click **Room**, and then select the room to be deleted. To delete the room, click **Edit**, and then click **Delete**.
