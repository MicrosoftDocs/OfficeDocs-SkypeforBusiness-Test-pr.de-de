...
ms:mtpsurl: https://technet.microsoft.com/de-de/library/JJ204622(v=OCS.15)
ms:contentKeyID: 49292978
ms.date: 05/19/2016
...
Enables you to modify a centralized logging configuration scenario. A scenario represents a particular Lync Server 2013 component or situation (such as IM and presence) that administrators can enable or disable for tracing. Dieses Cmdlet wurde in Lync Server 2013 eingeführt.
...
Lync Server-Systemsteuerung: The functions carried out by the **Set-CsClsScenario** cmdlet are not available in the Lync Server-Systemsteuerung.
