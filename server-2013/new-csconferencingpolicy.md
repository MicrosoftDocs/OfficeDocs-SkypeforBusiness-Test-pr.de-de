...
ms:mtpsurl: https://technet.microsoft.com/de-de/library/Gg413019(v=OCS.15)
ms:contentKeyID: 49295884
ms.date: 12/10/2016
...
Creates a new conferencing policy for use in your organization. Conferencing policies determine the features and capabilities that can be used in a conference; this includes everything from whether or not the conference can include IP audio and video to the maximum number of people who can attend a meeting. Dieses Cmdlet wurde in Lync Server 2010 eingeführt.
...
<td><p>Optional</p></td>
<td><p>System.Boolean</p></td>
<td><p>Indicates whether anonymous users are allowed to participate in the meeting. If set to False then only authenticated users (that is, users logged on to your Active Directory-Domänendienste or the Active Directory of a federated partner) are allowed to attend the meeting. The default value is True.</p>
