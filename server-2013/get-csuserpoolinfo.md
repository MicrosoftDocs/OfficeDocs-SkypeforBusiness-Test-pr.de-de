...
ms:mtpsurl: https://technet.microsoft.com/de-de/library/Gg398615(v=OCS.15)
ms:contentKeyID: 49294513
ms.date: 05/19/2016
...
Returns information about the Registrar pool, backup Registrar pool, and User Services pool that a user has been assigned to. Dieses Cmdlet wurde in Lync Server 2010 eingeführt.
...
<td><p>Retrieves the user pool information from the local replica of the zentralen Verwaltungsspeicher rather than from the zentralen Verwaltungsspeicher itself.</p></td>
</tr>
</tbody>
</table>
