...
ms:mtpsurl: https://technet.microsoft.com/de-de/library/Gg425893(v=OCS.15)
ms:contentKeyID: 49293746
ms.date: 05/19/2016
...
Creates a new collection of Registrar configuration settings. Registrars are used to authenticate logon requests and to maintain information about user status and availability. Dieses Cmdlet wurde in Lync Server 2010 eingeführt.
