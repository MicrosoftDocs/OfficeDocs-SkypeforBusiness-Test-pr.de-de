...
ms:mtpsurl: https://technet.microsoft.com/de-de/library/Gg413043(v=OCS.15)
ms:contentKeyID: 49295940
ms.date: 05/19/2016
...
Returns information about the dial plans used in your organization. Dieses Cmdlet wurde in Lync Server 2010 eingeführt.
...
<td><p>Retrieves the dial plan information from the local replica of the zentralen Verwaltungsspeicher, rather than the zentralen Verwaltungsspeicher itself.</p></td>
</tr>
</tbody>
</table>
