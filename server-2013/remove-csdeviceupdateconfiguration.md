...
ms:mtpsurl: https://technet.microsoft.com/de-de/library/Gg425933(v=OCS.15)
ms:contentKeyID: 49293831
ms.date: 05/19/2016
...
Removes the specified device update configuration settings. These settings help manage the Geräteaktualisierungswebdienst, a Lync Server component that enables administrators to distribute firmware updates to telephones and other devices running Lync Phone Edition. Dieses Cmdlet wurde in Lync Server 2010 eingeführt.
