...
ms:mtpsurl: https://technet.microsoft.com/de-de/library/Gg398754(v=OCS.15)
ms:contentKeyID: 49294788
ms.date: 05/19/2016
...
Returns information about the static routing configuration settings used in your organization. Dieses Cmdlet wurde in Lync Server 2010 eingeführt.
...
<td><p>Retrieves the static routing configuration data from the local replica of the zentralen Verwaltungsspeicher rather than from the zentralen Verwaltungsspeicher itself.</p></td>
</tr>
</tbody>
</table>
