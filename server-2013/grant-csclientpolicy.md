...
ms:mtpsurl: https://technet.microsoft.com/de-de/library/Gg412942(v=OCS.15)
ms:contentKeyID: 49295290
ms.date: 05/19/2016
...
Assigns a client policy to a user or a group of users. Among other things, client policies help determine the features of Lync Server that are available to users; for example, you might give some users the right to transfer files while denying this right to other users. Dieses Cmdlet wurde in Lync Server 2010 eingeführt.
