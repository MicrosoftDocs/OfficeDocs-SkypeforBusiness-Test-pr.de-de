...
ms:mtpsurl: https://technet.microsoft.com/de-de/library/Hh689989(v=OCS.15)
ms:contentKeyID: 49293009
ms.date: 05/19/2016
...
Verifies that authenticated users can use Lync Web App to join a Lync Server conference. Dieses Cmdlet wurde in Lync Server 2010 eingeführt.
