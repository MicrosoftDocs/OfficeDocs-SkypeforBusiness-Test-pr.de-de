...
ms:mtpsurl: https://technet.microsoft.com/de-de/library/Gg398733(v=OCS.15)
ms:contentKeyID: 49294740
ms.date: 05/19/2016
...
Creates new diagnostic configuration settings. Diagnostic configuration settings are used to determine whether traffic to or from a given domain or Uniform Resource Identifier (URI) is recorded in your Lync Server log files. Dieses Cmdlet wurde in Lync Server 2010 eingeführt.
