...
ms:mtpsurl: https://technet.microsoft.com/de-de/library/Dn747889(v=OCS.15)
ms:contentKeyID: 62293614
ms.date: 05/19/2016
...
Check conferencing Attendant settings for PSTN dial-in conferencing. Conferencing Attendant settings can only be retrieved by using the **Get-CsDialInConferencingConfiguration** cmdlet. These settings are not available in the Lync Server-Systemsteuerung. To view your Conferencing Attendant settings, use a Windows PowerShell command similar to the following, which returns the global collection of Conferencing Attendant settings:
