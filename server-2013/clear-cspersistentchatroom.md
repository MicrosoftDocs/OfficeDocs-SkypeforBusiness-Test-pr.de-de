...
ms:mtpsurl: https://technet.microsoft.com/de-de/library/JJ204976(v=OCS.15)
ms:contentKeyID: 49294311
ms.date: 05/19/2016
...
Removes all the content from a Persistent Chat chat room beginning with the oldest item in the room and continuing through the specified end date. Dieses Cmdlet wurde in Lync Server 2013 eingeführt.
...
**Lync Server-Systemsteuerung:** The functions carried out by the **Clear-CsPersistentChatRoom** cmdlet are not available in the Lync Server-Systemsteuerung.
