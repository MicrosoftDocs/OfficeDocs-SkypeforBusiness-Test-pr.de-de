...
ms:mtpsurl: https://technet.microsoft.com/de-de/library/JJ205058(v=OCS.15)
ms:contentKeyID: 49294661
ms.date: 05/19/2016
...
Verifies that a user can connect to Exchange Unified Messaging and leave a voice mail message for another user. Dieses Cmdlet wurde in Lync Server 2013 eingeführt.
...
**Lync Server-Systemsteuerung:** The functions carried out by the Test-CsExUMVoiceMail cmdlet are not available in the Lync Server-Systemsteuerung.
