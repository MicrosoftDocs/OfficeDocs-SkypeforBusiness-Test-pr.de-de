...
ms:mtpsurl: https://technet.microsoft.com/de-de/library/JJ205227(v=OCS.15)
ms:contentKeyID: 49295267
ms.date: 05/19/2016
...
Tests the ability of a pair of users to take part in an application sharing conference. Dieses Cmdlet wurde in Lync Server 2013 eingeführt.
...
**Lync Server-Systemsteuerung:** The functions carried out by the Test-CsASConference cmdlet are not available in the Lync Server-Systemsteuerung.
