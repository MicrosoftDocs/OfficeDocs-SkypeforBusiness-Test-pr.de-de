...
ms:mtpsurl: https://technet.microsoft.com/de-de/library/JJ204801(v=OCS.15)
ms:contentKeyID: 49293672
ms.date: 05/19/2016
...
Modifies and existing Persistent Chat chat room. A chat room is a discussion forum that typically revolves around a specific topic. Dieses Cmdlet wurde in Lync Server 2013 eingeführt.
...
**Lync Server-Systemsteuerung:** To modify an existing Persistent Chat chat room using the Lync Server-Systemsteuerung, click **Persistent Chat**, click **Room**, then double-click the chat room to be modified.
