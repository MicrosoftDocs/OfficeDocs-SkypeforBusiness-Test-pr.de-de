...
ms:mtpsurl: https://technet.microsoft.com/de-de/library/JJ204661(v=OCS.15)
ms:contentKeyID: 49293129
ms.date: 05/19/2016
...
**Lync Server-Systemsteuerung:** The functions carried out by the **Invoke-CsUcsRollback** cmdlet are not available in the Lync Server-Systemsteuerung.
