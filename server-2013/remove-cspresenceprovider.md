...
ms:mtpsurl: https://technet.microsoft.com/de-de/library/JJ205036(v=OCS.15)
ms:contentKeyID: 49294537
ms.date: 05/19/2016
...
Removes a presence provider previously configured for use in the organization. Presence providers represent the PresenceProviders property of a collection of user services configuration settings. Dieses Cmdlet wurde in Lync Server 2013 eingeführt.
...
**Lync Server-Systemsteuerung:** The functions carried out by the **Remove-CsPresenceProvider** cmdlet are not available in the Lync Server-Systemsteuerung.
