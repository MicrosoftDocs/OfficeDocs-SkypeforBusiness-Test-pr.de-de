...
ms:mtpsurl: https://technet.microsoft.com/de-de/library/Gg398122(v=OCS.15)
ms:contentKeyID: 49293062
ms.date: 05/19/2016
...
Undoes the forest preparation tasks carried out by the **Enable-CsAdForest** cmdlet. This cmdlet is typically used only if you are uninstalling Lync Server. Dieses Cmdlet wurde in Lync Server 2010 eingeführt.
