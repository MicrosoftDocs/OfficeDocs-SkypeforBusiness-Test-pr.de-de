...
ms:mtpsurl: https://technet.microsoft.com/de-de/library/JJ204627(v=OCS.15)
ms:contentKeyID: 49292991
ms.date: 05/19/2016
...
Manually purges records from the Archiving database. Dieses Cmdlet wurde in Lync Server 2013 eingeführt.
...
**Lync Server-Systemsteuerung:** The functions carried out by the **Invoke-CsArchivingDatabasePurge** cmdlet are not available in the Lync Server-Systemsteuerung.
