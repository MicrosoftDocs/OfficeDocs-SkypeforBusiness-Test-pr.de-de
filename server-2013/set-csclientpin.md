...
ms:mtpsurl: https://technet.microsoft.com/de-de/library/Gg398929(v=OCS.15)
ms:contentKeyID: 49295533
ms.date: 05/19/2016
...
Assigns a new personal identification number (PIN) to the specified user. Dieses Cmdlet wurde in Lync Server 2010 eingeführt. Note that the Lync Server 2013 version of this cmdlet can only assign PIN numbers to users homed on Lync Server 2013. You should use the Lync Server 2010 version of Set-CsClientPin to assign PIN numbers to users homed on Lync Server 2010.
