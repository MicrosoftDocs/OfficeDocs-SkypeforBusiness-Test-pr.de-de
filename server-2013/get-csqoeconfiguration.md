...
ms:mtpsurl: https://technet.microsoft.com/de-de/library/Gg399004(v=OCS.15)
ms:contentKeyID: 49295688
ms.date: 05/19/2016
...
Retrieves one or more collections of Quality of Experience (QoE) settings. Dieses Cmdlet wurde in Lync Server 2010 eingeführt.
...
<td><p>Retrieves the settings from the local replica of the zentralen Verwaltungsspeicher.</p></td>
</tr>
</tbody>
</table>
