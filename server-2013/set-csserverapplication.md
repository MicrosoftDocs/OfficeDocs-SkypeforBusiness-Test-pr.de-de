...
ms:mtpsurl: https://technet.microsoft.com/de-de/library/Gg412850(v=OCS.15)
ms:contentKeyID: 49295114
ms.date: 05/19/2016
...
Modifies the property values of an existing server application. Server applications are applications that are hosted by Lync Server. Dieses Cmdlet wurde in Lync Server 2010 eingeführt.
