...
ms:mtpsurl: https://technet.microsoft.com/de-de/library/JJ204952(v=OCS.15)
ms:contentKeyID: 49294184
ms.date: 05/19/2016
...
Modifies an existing Persistent Chat category. A Persistent Chat category represents a collection of Persistent Chat chat rooms. Each chat room must be associated with a category. Dieses Cmdlet wurde in Lync Server 2013 eingeführt.
...
**Lync Server-Systemsteuerung:** To modify an existing Persistent Chat category using the Lync Server-Systemsteuerung, click **Persistent Chat**, click **Category**, then double-click the category to be modified.
