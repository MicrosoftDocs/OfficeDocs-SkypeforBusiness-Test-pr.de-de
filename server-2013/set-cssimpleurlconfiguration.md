...
ms:mtpsurl: https://technet.microsoft.com/de-de/library/Gg412991(v=OCS.15)
ms:contentKeyID: 49295846
ms.date: 05/19/2016
...
Modifies an existing simple URL configuration collection. Simple URLs make it easier for users to join meetings and conferences, as well as making it easier for Administrators to log on to the Lync Server-Systemsteuerung. Dieses Cmdlet wurde in Lync Server 2010 eingeführt.
