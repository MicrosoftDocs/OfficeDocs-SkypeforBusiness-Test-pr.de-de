...
ms:mtpsurl: https://technet.microsoft.com/de-de/library/Gg412812(v=OCS.15)
ms:contentKeyID: 49295058
ms.date: 05/19/2016
...
Creates a new Response Group answer. Response Group answers are used to associate a caller response with the appropriate action. Dieses Cmdlet wurde in Lync Server 2010 eingeführt.
