...
ms:mtpsurl: https://technet.microsoft.com/de-de/library/Gg398786(v=OCS.15)
ms:contentKeyID: 49294845
ms.date: 05/19/2016
...
Enables you to remove an existing collection of configuration settings applied to computers running the Zugriffs-Edgedienst (these computers are also known as A/V Edge servers). An A/V Edge server enables internal users to share audio and video data with external users (that is, users who are not logged on to your internal network). Dieses Cmdlet wurde in Lync Server 2010 eingeführt.
