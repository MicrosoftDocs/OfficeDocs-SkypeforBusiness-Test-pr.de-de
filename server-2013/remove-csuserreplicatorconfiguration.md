...
ms:mtpsurl: https://technet.microsoft.com/de-de/library/Gg425738(v=OCS.15)
ms:contentKeyID: 49293467
ms.date: 05/19/2016
...
Removes the specified collection of User Replicator configuration settings. The User Replicator periodically retrieves up-to-date user account information from Active Directory and then synchronizes the new information with the current user data stored by Lync Server. Dieses Cmdlet wurde in Lync Server 2010 eingeführt.
