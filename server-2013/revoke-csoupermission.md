...
ms:mtpsurl: https://technet.microsoft.com/de-de/library/Gg398977(v=OCS.15)
ms:contentKeyID: 49295633
ms.date: 05/19/2016
...
Revokes the Lync Server management permissions that have been granted on an Active Directory organizational unit (OU). Dieses Cmdlet wurde in Lync Server 2010 eingeführt.
