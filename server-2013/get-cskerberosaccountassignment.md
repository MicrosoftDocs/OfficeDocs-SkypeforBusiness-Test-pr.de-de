...
ms:mtpsurl: https://technet.microsoft.com/de-de/library/Gg398526(v=OCS.15)
ms:contentKeyID: 49294351
ms.date: 05/19/2016
...
Returns information about the Kerberos account assignments configured for use in the organization. Dieses Cmdlet wurde in Lync Server 2010 eingeführt.
...
<td><p>Retrieves the Kerberos assignment data from the local replica of the zentralen Verwaltungsspeicher rather than from the zentralen Verwaltungsspeicher itself.</p></td>
</tr>
</tbody>
</table>
