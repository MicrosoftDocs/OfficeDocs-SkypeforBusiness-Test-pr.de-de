...
ms:mtpsurl: https://technet.microsoft.com/de-de/library/Gg398471(v=OCS.15)
ms:contentKeyID: 49294245
ms.date: 05/19/2016
...
Creates a new set of instant messaging (IM) archiving settings. These settings can be used to enable or disable the automatic saving of IM sessions; these settings also enable you to block any instant messages that cannot be archived. Dieses Cmdlet wurde in Lync Server 2010 eingeführt.
