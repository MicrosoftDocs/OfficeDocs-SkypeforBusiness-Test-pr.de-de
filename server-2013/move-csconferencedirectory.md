...
ms:mtpsurl: https://technet.microsoft.com/de-de/library/Gg412968(v=OCS.15)
ms:contentKeyID: 49295332
ms.date: 05/19/2016
...
_**Letztes Änderungsdatum des Themas:** 2015-05-28_

Moves an existing conference directory from one pool to another. Conference directories are used to help dial-in conferencing users locate conference information. Dieses Cmdlet wurde in Lync Server 2010 eingeführt.
