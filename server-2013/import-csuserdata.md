...
ms:mtpsurl: https://technet.microsoft.com/de-de/library/JJ205373(v=OCS.15)
ms:contentKeyID: 49295889
ms.date: 05/19/2016
...
Imports user data previously exported by using the Export-CsUserData cmdlet. Dieses Cmdlet wurde in Lync Server 2013 eingeführt.
...
**Lync Server-Systemsteuerung:** The functions carried out by the **Import-CsUserData** cmdlet are not available in the Lync Server-Systemsteuerung.
