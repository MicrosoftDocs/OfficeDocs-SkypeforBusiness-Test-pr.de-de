...
ms:mtpsurl: https://technet.microsoft.com/de-de/library/JJ619178(v=OCS.15)
ms:contentKeyID: 49293957
ms.date: 05/19/2016
...
Tests the ability of a pair of users to schedule, join, and then conduct an online conference using the Unified Communications Web API (UCWA). Dieses Cmdlet wurde in Lync Server 2013 eingeführt.
...
**Lync Server-Systemsteuerung:** The functions carried out by the **Test-CsUcwaConference** cmdlet are not available in the Lync Server-Systemsteuerung.
