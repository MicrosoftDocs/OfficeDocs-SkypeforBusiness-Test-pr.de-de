...
ms:mtpsurl: https://technet.microsoft.com/de-de/library/Gg412884(v=OCS.15)
ms:contentKeyID: 49295168
ms.date: 05/19/2016
...
Creates a new collection of configuration settings for computers running the A/V-Edgedienst (these computers are also known as A/V Edge servers). An A/V Edge server enables internal users to share audio and video data with external users (that is, users who are not logged on to your internal network). Dieses Cmdlet wurde in Lync Server 2010 eingeführt.
