---
title: Index der Lync Server 2013-Cmdlets
TOCTitle: Index der Lync Server 2013-Cmdlets
ms:assetid: cd37aba7-3d27-4db9-b69f-3a6da1fb4b4a
ms:mtpsurl: https://technet.microsoft.com/de-de/library/Gg398867(v=OCS.15)
ms:contentKeyID: 49295436
ms.date: 12/10/2016
mtps_version: v=OCS.15
ms.translationtype: HT
---

# Index der Lync Server 2013-Cmdlets

 

_**Letztes Änderungsdatum des Themas:** 2016-12-08_

Zum Lieferumfang von Microsoft Lync Server 2013 gehören über 700 Cmdlets, die Administratoren bei der Verwaltung von Lync Server 2013 über die Befehlszeile unterstützen. Die Lync Server-Cmdlets werden in der Regel mit der Lync Server-Verwaltungsshell eingesetzt. Eine Möglichkeit zur Verwendung der Lync Server-Verwaltungsshell besteht darin, sich an einem Computer anzumelden, auf dem ein Lync Server-Dienst oder eine Serverrolle ausgeführt wird, nacheinander auf **Start**, **Alle Programme** und **Microsoft Lync Server 2013** und anschließend auf **Lync Server-Verwaltungsshell** zu klicken. Nach dem Öffnen der Verwaltungsshell können Sie Hilfeinformationen zu einem Cmdlet direkt über die Befehlszeile abrufen, indem Sie einen Befehl eingeben, der so oder ähnlich aussieht:
...
Geben Sie den folgenden Befehl an der Eingabeaufforderung der Lync Server-Verwaltungsshell ein, um eine vollständige Liste der verfügbaren Cmdlets für die Lync Server-Verwaltung anzuzeigen:

    Get-Command * -Module Lync -CommandType cmdlet

Ausführliche Informationen zur Verwendung der Lync Server-Verwaltungsshell finden Sie im Lync Server Windows PowerShell-Blog unter [http://go.microsoft.com/fwlink/?linkid=203150\&clcid=0x407](http://go.microsoft.com/fwlink/?linkid=203150%26clcid=0x407).

## Lync Server 2013-Cmdlets

In der nachfolgenden Liste werden alle Cmdlets aufgeführt, die zum Lieferumfang von Lync Server 2013 gehören:
