...
ms:mtpsurl: https://technet.microsoft.com/de-de/library/JJ204839(v=OCS.15)
ms:contentKeyID: 49293805
ms.date: 05/19/2016
...
Tests the configuration of the Lync Server 2013 databases. Dieses Cmdlet wurde in Lync Server 2013 eingeführt.
...
**Lync Server-Systemsteuerung:** The functions carried out by the **Test-CsDatabase** cmdlet are not available in the Lync Server-Systemsteuerung.
