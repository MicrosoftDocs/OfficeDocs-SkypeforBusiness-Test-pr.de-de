...
ms:mtpsurl: https://technet.microsoft.com/de-de/library/Gg425745(v=OCS.15)
ms:contentKeyID: 49293480
ms.date: 05/19/2016
...
Creates a new SipProxy.TCP object, which can then be used to configure a static route to use Transmission Control Protocol (TCP) as its transport protocol. Dieses Cmdlet wurde in Lync Server 2010 eingeführt.
