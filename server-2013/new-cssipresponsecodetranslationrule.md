...
ms:mtpsurl: https://technet.microsoft.com/de-de/library/Gg413041(v=OCS.15)
ms:contentKeyID: 49295939
ms.date: 05/19/2016
...
Creates a new SIP response code translation rule. These rules enable administrators to map SIP response codes with values between 400 and 699 to the values used by Lync Server. Dieses Cmdlet wurde in Lync Server 2010 eingeführt.
