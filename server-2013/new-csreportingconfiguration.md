...
ms:mtpsurl: https://technet.microsoft.com/de-de/library/JJ204787(v=OCS.15)
ms:contentKeyID: 49293562
ms.date: 05/19/2016
...
Creates a new collection of reporting configuration settings at the service scope. Reporting configuration settings are used to specify the URL used to access Lync Server 2013 Monitoring Reports. Dieses Cmdlet wurde in Lync Server 2013 eingeführt.
...
**Lync Server-Systemsteuerung:** The functions carried out by the **New-CsReportingConfiguration** cmdlet are not available in the Lync Server-Systemsteuerung.
