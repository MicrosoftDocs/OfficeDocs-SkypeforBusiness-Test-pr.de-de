...
ms:mtpsurl: https://technet.microsoft.com/de-de/library/Gg398815(v=OCS.15)
ms:contentKeyID: 49295348
ms.date: 05/19/2016
...
Retrieves the voice configuration object, which contains a full list of all voice test configurations defined for the Lync Server deployment. Dieses Cmdlet wurde in Lync Server 2010 eingeführt.
...
<td><p>Retrieves the voice configuration from the local replica of the zentralen Verwaltungsspeicher, rather than the zentralen Verwaltungsspeicher itself.</p></td>
</tr>
</tbody>
</table>
