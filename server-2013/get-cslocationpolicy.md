...
ms:mtpsurl: https://technet.microsoft.com/de-de/library/Gg398911(v=OCS.15)
ms:contentKeyID: 49295499
ms.date: 05/19/2016
...
Returns information about how (or if) the Enhanced 9-1-1 (E9-1-1) Standortinformationsdienst has been configured. The E9-1-1 service enables those who answer emergency calls to determine the caller’s geographic location. Dieses Cmdlet wurde in Lync Server 2010 eingeführt.
...
<td><p>Retrieves the location policy information from the local replica of the zentralen Verwaltungsspeicher, rather than the zentralen Verwaltungsspeicher itself.</p></td>
</tr>
</tbody>
</table>
