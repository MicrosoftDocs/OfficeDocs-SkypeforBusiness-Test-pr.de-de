...
ms:mtpsurl: https://technet.microsoft.com/de-de/library/Gg412947(v=OCS.15)
ms:contentKeyID: 49295296
ms.date: 05/19/2016
...
Modifies an existing Response Group queue. With the Reaktionsgruppenanwendung, phone calls are put in a queue and callers are placed on hold until a Response Group agent is available to answer that call. Dieses Cmdlet wurde in Lync Server 2010 eingeführt.
