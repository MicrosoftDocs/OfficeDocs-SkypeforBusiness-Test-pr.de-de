...
ms:mtpsurl: https://technet.microsoft.com/de-de/library/Gg413008(v=OCS.15)
ms:contentKeyID: 49295866
ms.date: 05/19/2016
...
Returns configuration information for computers running the A/V-Edgedienst in your organization. The configuration settings on these computers, also known as A/V Edge servers, enable internal users to share audio and video data with external users (that is, users who are not logged on to your internal network), as well as exchange files and participate in desktop sharing sessions. Dieses Cmdlet wurde in Lync Server 2010 eingeführt.
...
<td><p>Retrieves the A/V Edge configuration data from the local replica of the zentralen Verwaltungsspeicher rather than from the zentralen Verwaltungsspeicher itself.</p></td>
</tr>
</tbody>
</table>
