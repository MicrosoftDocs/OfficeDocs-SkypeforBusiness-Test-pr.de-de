...
ms:mtpsurl: https://technet.microsoft.com/de-de/library/JJ204771(v=OCS.15)
ms:contentKeyID: 49293548
ms.date: 05/19/2016
...
Returns information about the Persistent Chat categories in use in your organization. A Persistent Chat category represents a collection of Persistent Chat chat rooms. Each chat room must be associated with a category. Dieses Cmdlet wurde in Lync Server 2013 eingeführt.
...
**Lync Server-Systemsteuerung:** To view Persistent Chat categories in Lync Server-Systemsteuerung, click **Persistent Chat** and then click **Category**.
