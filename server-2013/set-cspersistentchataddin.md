...
ms:mtpsurl: https://technet.microsoft.com/de-de/library/JJ204721(v=OCS.15)
ms:contentKeyID: 49293341
ms.date: 05/19/2016
...
Modifies an existing Persistent Chat add-in. A Persistent Chat add-in is a customized web page that can be embedded within a Persistent Chat client. Dieses Cmdlet wurde in Lync Server 2013 eingeführt.
...
**Lync Server-Systemsteuerung:** To modify an existing Persistent Chat add-in using the Lync Server-Systemsteuerung, click **Persistent Chat**, click **Add-in**, then double-click the add-in to be modified.
