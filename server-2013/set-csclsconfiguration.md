...
ms:mtpsurl: https://technet.microsoft.com/de-de/library/JJ619182(v=OCS.15)
ms:contentKeyID: 49294326
ms.date: 05/19/2016
...
Modifies an existing collection of centralized logging configuration settings. Centralized logging provides a way for administrators to simultaneously enable or disable tracing on multiple computers. Dieses Cmdlet wurde in Lync Server 2013 eingeführt.
...
**Lync Server-Systemsteuerung:** The functions carried out by the **Set-CsClsConfiguration** cmdlet are not available in the Lync Server-Systemsteuerung.
