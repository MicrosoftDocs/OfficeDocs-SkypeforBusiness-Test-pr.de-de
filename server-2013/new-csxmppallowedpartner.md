...
ms:mtpsurl: https://technet.microsoft.com/de-de/library/JJ204631(v=OCS.15)
ms:contentKeyID: 49293003
ms.date: 05/19/2016
...
**Lync Server-Systemsteuerung:** To create a new XMPP allowed partner using Lync Server-Systemsteuerung, click External User Access, click XMPP Federated Partners, and then click New.
