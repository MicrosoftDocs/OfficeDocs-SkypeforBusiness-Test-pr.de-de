...
ms:mtpsurl: https://technet.microsoft.com/de-de/library/Gg412937(v=OCS.15)
ms:contentKeyID: 49295286
ms.date: 05/19/2016
...
Creates a new analog device that can be managed by using Lync Server. An analog device is a telephone or other device that is connected to the public switched telephone network (PSTN). Dieses Cmdlet wurde in Lync Server 2010 eingeführt.
