...
ms:mtpsurl: https://technet.microsoft.com/de-de/library/Gg425766(v=OCS.15)
ms:contentKeyID: 49293510
ms.date: 05/19/2016
...
Returns information about Response Group workflows. Workflows determine the actions that are taken when the Reaktionsgruppenanwendung receives a phone call. Dieses Cmdlet wurde in Lync Server 2010 eingeführt.
...
Example 2 returns information about all the Reaktionsgruppenanwendung workflows found on the service ApplicationServer:atl-cs-001.litwareinc.com.
