...
ms:mtpsurl: https://technet.microsoft.com/de-de/library/JJ204625(v=OCS.15)
ms:contentKeyID: 49292986
ms.date: 05/19/2016
...
**Lync Server-Systemsteuerung:** The functions carried out by the **Get-CsPersistentChatComplianceConfiguration** cmdlet are not available in the Lync Server-Systemsteuerung.
