...
ms:mtpsurl: https://technet.microsoft.com/de-de/library/Gg398592(v=OCS.15)
ms:contentKeyID: 49294472
ms.date: 05/19/2016
...
Returns information about all the user accounts in Active Directory-Domänendienste. This includes user accounts that have been enabled for Lync Server as well as accounts that have not been enabled for Lync Server. Dieses Cmdlet wurde in Lync Server 2010 eingeführt.
