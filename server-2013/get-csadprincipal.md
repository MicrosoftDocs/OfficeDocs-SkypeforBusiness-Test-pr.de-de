...
ms:mtpsurl: https://technet.microsoft.com/de-de/library/JJ205326(v=OCS.15)
ms:contentKeyID: 49295644
ms.date: 05/19/2016
...
Returns information about Active Directory principals. These principals include Active Directory objects such as users, groups, contacts, containers, and organizational units. Dieses Cmdlet wurde in Lync Server 2013 eingeführt.
...
**Lync Server-Systemsteuerung:** The functions carried out by the Get-CsAdPrincipal cmdlet are not available in the Lync Server-Systemsteuerung.
