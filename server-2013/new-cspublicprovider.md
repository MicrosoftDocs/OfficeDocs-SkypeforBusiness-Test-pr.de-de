...
ms:mtpsurl: https://technet.microsoft.com/de-de/library/Gg398161(v=OCS.15)
ms:contentKeyID: 49293134
ms.date: 05/19/2016
...
Creates a federation relationship with a new public provider. A public provider is an organization that provides instant messaging, presence, and related services to the general public. Lync Server ships with three public providers configured but not enabled: Yahoo; AIM (AOL); and Messenger (MSN). Dieses Cmdlet wurde in Lync Server 2010 eingeführt.
