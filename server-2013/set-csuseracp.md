...
ms:mtpsurl: https://technet.microsoft.com/de-de/library/Gg413018(v=OCS.15)
ms:contentKeyID: 49295883
ms.date: 05/19/2016
...
Adds a new audio conferencing provider to a user or group of users, or modifies an existing audio conferencing provider already assigned to a user. Dieses Cmdlet wurde in Lync Server 2010 eingeführt.
