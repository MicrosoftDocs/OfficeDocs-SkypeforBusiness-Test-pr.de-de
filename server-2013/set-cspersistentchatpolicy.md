...
ms:mtpsurl: https://technet.microsoft.com/de-de/library/JJ205192(v=OCS.15)
ms:contentKeyID: 49295174
ms.date: 05/19/2016
...
Modifies an existing Persistent Chat policy. Persistent Chat policies determine whether or not users are allowed access to Persistent Chat chat rooms. Dieses Cmdlet wurde in Lync Server 2013 eingeführt.
...
**Lync Server-Systemsteuerung:** To modify an existing Persistent Chat policy using the Lync Server-Systemsteuerung, click **Persistent Chat**, click **Persistent Chat Policy**, then double-click the policy to be modified.
