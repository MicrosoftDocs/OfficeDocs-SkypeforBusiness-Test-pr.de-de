...
ms:mtpsurl: https://technet.microsoft.com/de-de/library/Gg398554(v=OCS.15)
ms:contentKeyID: 49294419
ms.date: 05/19/2016
...
Gets the call park orbit range settings for the organization. Dieses Cmdlet wurde in Lync Server 2010 eingeführt.
...
<td><p>Retrieves the call park orbit information from the local replica of the zentralen Verwaltungsspeicher, rather than the zentralen Verwaltungsspeicher itself.</p></td>
</tr>
<tr class="even">
