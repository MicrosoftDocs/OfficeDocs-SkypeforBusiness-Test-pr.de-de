...
ms:mtpsurl: https://technet.microsoft.com/de-de/library/JJ205232(v=OCS.15)
ms:contentKeyID: 49295295
ms.date: 05/19/2016
...
Verifies replication between Active Directory and the Lync Server 2013 Address book service. Dieses Cmdlet wurde in Lync Server 2013 eingeführt.
...
**Lync Server-Systemsteuerung:** The functions carried out by the D**ebug-CsAddressBookReplication** cmdlet are not available in the Lync Server-Systemsteuerung.
