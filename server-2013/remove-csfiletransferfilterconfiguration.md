...
ms:mtpsurl: https://technet.microsoft.com/de-de/library/Gg413064(v=OCS.15)
ms:contentKeyID: 49295974
ms.date: 05/19/2016
...
Removes the specified instant message file transfer filter configuration. (Instant message file transfer filter settings are used to block a user’s ability to transfer certain types of files within an instant message.) Dieses Cmdlet wurde in Lync Server 2010 eingeführt.
