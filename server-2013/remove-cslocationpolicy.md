...
ms:mtpsurl: https://technet.microsoft.com/de-de/library/Gg398727(v=OCS.15)
ms:contentKeyID: 49294733
ms.date: 05/19/2016
...
Removes the specified location policy. (Location policies are used with the Enhanced 9-1-1 service to enable those who answer 911 calls to determine the caller’s geographic location based on the phone number of the telephone or device used to make the call.) Dieses Cmdlet wurde in Lync Server 2010 eingeführt.
