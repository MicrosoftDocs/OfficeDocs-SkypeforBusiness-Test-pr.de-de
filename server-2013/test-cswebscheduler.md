...
ms:mtpsurl: https://technet.microsoft.com/de-de/library/JJ204829(v=OCS.15)
ms:contentKeyID: 49293766
ms.date: 05/19/2016
...
Verifies whether or not a user can employ the Lync Server 2013 Web scheduler to schedule an online meeting. Dieses Cmdlet wurde in Lync Server 2013 eingeführt.
...
**Lync Server-Systemsteuerung:** The functions carried out by the **Test-CsWebScheduler** cmdlet are not available in the Lync Server-Systemsteuerung.
