...
ms:mtpsurl: https://technet.microsoft.com/de-de/library/JJ205350(v=OCS.15)
ms:contentKeyID: 49295678
ms.date: 05/19/2016
...
Removes an existing Persistent Chat add-in. A Persistent Chat add-in is a customized web page that can be embedded within a Persistent Chat client. Dieses Cmdlet wurde in Lync Server 2013 eingeführt.
...
**Lync Server-Systemsteuerung:** To remove a Persistent Chat add-in using the Lync Server-Systemsteuerung, click **Persistent Chat** and then click **Add-in**. Select the add-in to be removed, click **Edit**, and then click **Delete**.
