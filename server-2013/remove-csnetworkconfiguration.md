...
ms:mtpsurl: https://technet.microsoft.com/de-de/library/Gg398938(v=OCS.15)
ms:contentKeyID: 49295550
ms.date: 05/19/2016
...
Resets all the network configuration settings for a Lync Server deployment to the default values. This deletes an entire call admission control (CAC) deployment and related E9-1-1 configuration. Dieses Cmdlet wurde in Lync Server 2010 eingeführt.
...
<td><p>Fordert Sie vor der Ausführung des Befehls zum Bestätigen auf. It is recommended that you always use this parameter with this cmdlet.</p></td>
</tr>
<tr class="odd">
