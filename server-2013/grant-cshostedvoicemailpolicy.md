...
ms:mtpsurl: https://technet.microsoft.com/de-de/library/Gg412829(v=OCS.15)
ms:contentKeyID: 49295090
ms.date: 05/19/2016
...
Assigns a hosted voice mail policy at the per-user scope. (The per-user scope enables you to assign policies to individual users or groups.) Dieses Cmdlet wurde in Lync Server 2010 eingeführt.
