...
ms:mtpsurl: https://technet.microsoft.com/de-de/library/Gg398405(v=OCS.15)
ms:contentKeyID: 49294130
ms.date: 05/19/2016
...
Adds a computer that hosts trusted applications to an existing pool. Dieses Cmdlet wurde in Lync Server 2010 eingeführt.
