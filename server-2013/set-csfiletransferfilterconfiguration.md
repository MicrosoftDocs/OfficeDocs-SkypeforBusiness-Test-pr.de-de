...
ms:mtpsurl: https://technet.microsoft.com/de-de/library/Gg425736(v=OCS.15)
ms:contentKeyID: 49293465
ms.date: 05/19/2016
...
Modifies a collection of file transfer filter configuration settings. File transfer filter settings are used to block a user’s ability to transfer certain types of files (for example, files with a .vbs or .ps1 file extension) by using Lync Server clients. Dieses Cmdlet wurde in Lync Server 2010 eingeführt.
