...
ms:mtpsurl: https://technet.microsoft.com/de-de/library/Gg413013(v=OCS.15)
ms:contentKeyID: 49295879
ms.date: 05/19/2016
...
Identifies the route that a phone call from a given user would take to be completed based on voice rules, routes, and policies. Dieses Cmdlet wurde in Lync Server 2010 eingeführt.
