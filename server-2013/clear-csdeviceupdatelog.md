...
ms:mtpsurl: https://technet.microsoft.com/de-de/library/Gg412738(v=OCS.15)
ms:contentKeyID: 49294911
ms.date: 05/19/2016
...
Deletes all the Device Update Web service log and audit files that are older than the specified number of days. Dieses Cmdlet wurde in Lync Server 2010 eingeführt.
...
<td><p>Unique identifier of the service hosting the Device Update Web service log files. For example, this syntax clears Device Update Web service log files from the Webdienste for the pool atl-cs-001.litwareinc.com: -Identity &quot;service:WebServer:atl-cs-001.litwareinc.com&quot;.</p></td>
</tr>
<tr class="odd">
