...
ms:mtpsurl: https://technet.microsoft.com/de-de/library/JJ205072(v=OCS.15)
ms:contentKeyID: 49294703
ms.date: 05/19/2016
...
**Lync Server-Systemsteuerung:** The functions carried out by the **New-CsUserServicesPolicy** cmdlet are not available in the Lync Server-Systemsteuerung.
