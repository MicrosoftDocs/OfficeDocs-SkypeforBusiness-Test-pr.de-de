...
ms:mtpsurl: https://technet.microsoft.com/de-de/library/Gg398293(v=OCS.15)
ms:contentKeyID: 49293412
ms.date: 05/19/2016
...
Returns information about the conferencing policies that have been configured for use in your organization. Conferencing policies determine the features and capabilities that can be used in a conference; this includes everything from whether or not the conference can include IP audio and video to the maximum number of people who can attend a meeting. Dieses Cmdlet wurde in Lync Server 2010 eingeführt.
...
<td><p>Retrieves the conferencing policy data from the local replica of the zentralen Verwaltungsspeicher rather than from the zentralen Verwaltungsspeicher itself.</p></td>
</tr>
</tbody>
</table>
