...
ms:mtpsurl: https://technet.microsoft.com/de-de/library/JJ205062(v=OCS.15)
ms:contentKeyID: 49294662
ms.date: 05/19/2016
...
**Lync Server-Systemsteuerung:** The functions carried out by the **Enable-CsMeetingRoom** cmdlet are not available in the Lync Server-Systemsteuerung.
