...
ms:mtpsurl: https://technet.microsoft.com/de-de/library/JJ204853(v=OCS.15)
ms:contentKeyID: 49293832
ms.date: 05/19/2016
...
Returns information about client license usage in your organization. Dieses Cmdlet wurde in Lync Server 2013 eingeführt.
...
> [!TIP]
> For more information, and for ways to work around these issues, see the <A href="lync-server-2013-release-notes.md">Anmerkungen zu dieser Version für Lync Server 2013</A>.
...
**Lync Server-Systemsteuerung:** The functions carried out by the **Get-CsClientAccessLicense** cmdlet are not available in the Lync Server-Systemsteuerung.
