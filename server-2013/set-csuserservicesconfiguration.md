...
ms:mtpsurl: https://technet.microsoft.com/de-de/library/Gg398340(v=OCS.15)
ms:contentKeyID: 49293999
ms.date: 05/19/2016
...
Modifies an existing collection of User Services configuration settings. The User Services service is used to help maintain presence information and manage conferencing. Dieses Cmdlet wurde in Lync Server 2010 eingeführt.
