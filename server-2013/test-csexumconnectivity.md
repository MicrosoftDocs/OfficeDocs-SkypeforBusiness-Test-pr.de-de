...
ms:mtpsurl: https://technet.microsoft.com/de-de/library/JJ204784(v=OCS.15)
ms:contentKeyID: 49293547
ms.date: 05/19/2016
...
Verifies that a test user can connect to Exchange Unified Messaging. Dieses Cmdlet wurde in Lync Server 2013 eingeführt.
...
**Lync Server-Systemsteuerung:** The functions carried out by the **Test-CsExUMConnectivity** cmdlet are not available in the Lync Server-Systemsteuerung.
