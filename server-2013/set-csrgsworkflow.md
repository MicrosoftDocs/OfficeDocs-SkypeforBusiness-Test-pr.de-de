...
ms:mtpsurl: https://technet.microsoft.com/de-de/library/Gg425845(v=OCS.15)
ms:contentKeyID: 49293660
ms.date: 05/19/2016
...
Modifies an existing Response Group workflow. Workflows determine the actions that are taken when the Reaktionsgruppenanwendung receives a phone call. Dieses Cmdlet wurde in Lync Server 2010 eingeführt.
