...
ms:mtpsurl: https://technet.microsoft.com/de-de/library/Gg412922(v=OCS.15)
ms:contentKeyID: 49295241
ms.date: 05/19/2016
...
Deletes the specified Lync Server database. Dieses Cmdlet wurde in Lync Server 2010 eingeführt.
...
The command shown in Example 1 deletes the zentralen Verwaltungsspeicher from the computer atl-sql-001.litwareinc.com.
...
Lync Server makes extensive use of SQL Server databases such as the zentralen Verwaltungsspeicher and the Archivierungsdatenbank. These databases are set up at the same time you install Lync Server or at the same time you install a Lync Server role that requires a database back end. After the databases have been installed, you will rarely need to uninstall them.
...
<td><p>If present, uninstalls the zentralen Verwaltungsspeicher. You cannot use both CentralManagementDatabase and DatabaseType in the same command.</p></td>
</tr>
<tr class="even">
...
<p>Registrar</p>
<p>User</p>
<p>To delete the zentralen Verwaltungsspeicher, use the CentralManagementDatabase parameter.</p></td>
</tr>
<tr class="odd">
