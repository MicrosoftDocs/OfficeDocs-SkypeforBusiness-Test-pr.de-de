...
ms:mtpsurl: https://technet.microsoft.com/de-de/library/Gg398578(v=OCS.15)
ms:contentKeyID: 49294431
ms.date: 05/19/2016
...
Returns the dual-tone multifrequency (DTMF) signaling settings used for dial-in conferencing. DTMF enables users who dial in to a conference to control conference settings (such as muting and unmuting themselves or locking and unlocking the conference) by using the keypad on their telephone. Dieses Cmdlet wurde in Lync Server 2010 eingeführt.
...
<td><p>Retrieves the DTMF configuration data from the local replica of the zentralen Verwaltungsspeicher rather than from the zentralen Verwaltungsspeicher itself.</p></td>
</tr>
</tbody>
</table>
