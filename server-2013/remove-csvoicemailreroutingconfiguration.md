...
ms:mtpsurl: https://technet.microsoft.com/de-de/library/Gg398573(v=OCS.15)
ms:contentKeyID: 49294427
ms.date: 05/19/2016
...
Removes settings that provide public switched telephone network (PSTN) phone numbers to access Exchange UM Subscriber Access and Auto Attendant features. Dieses Cmdlet wurde in Lync Server 2010 eingeführt.
