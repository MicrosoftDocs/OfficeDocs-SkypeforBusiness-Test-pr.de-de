...
ms:mtpsurl: https://technet.microsoft.com/de-de/library/Gg425734(v=OCS.15)
ms:contentKeyID: 49293462
ms.date: 05/19/2016
...
Modifies existing diagnostic configuration settings. Diagnostic configuration settings are used to determine whether traffic to or from a given domain or Uniform Resource Identifier (URI) is recorded in your Lync Server log files. Dieses Cmdlet wurde in Lync Server 2010 eingeführt.
