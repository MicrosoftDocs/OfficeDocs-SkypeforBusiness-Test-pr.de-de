...
ms:mtpsurl: https://technet.microsoft.com/de-de/library/JJ205087(v=OCS.15)
ms:contentKeyID: 49294711
ms.date: 05/19/2016
...
**Lync Server-Systemsteuerung:** The functions carried out by the **Get-CsBackupServiceConfiguration** cmdlet are not available in the Lync Server-Systemsteuerung.
