...
ms:mtpsurl: https://technet.microsoft.com/de-de/library/Gg398629(v=OCS.15)
ms:contentKeyID: 49294541
ms.date: 05/19/2016
...
Creates a new SipProxy.TLS object, which can then be used to configure a static route to use Transport Layer Security (TLS) as its transport protocol. Dieses Cmdlet wurde in Lync Server 2010 eingeführt.
