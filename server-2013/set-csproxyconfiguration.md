...
ms:mtpsurl: https://technet.microsoft.com/de-de/library/Gg425796(v=OCS.15)
ms:contentKeyID: 49293560
ms.date: 01/13/2017
...
_**Letztes Änderungsdatum des Themas:** 2017-01-12_

Modifies an existing collection of proxy server configuration settings. Dieses Cmdlet wurde in Lync Server 2010 eingeführt.
...
<td><p>Optional</p></td>
<td><p>System.Boolean</p></td>
<td><p>When set to True, the proxy server functions as if all client connections are external connections that pass through the Edgeserver. The default value is False.</p></td>
</tr>
<tr class="odd">
