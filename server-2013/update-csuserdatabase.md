...
ms:mtpsurl: https://technet.microsoft.com/de-de/library/Gg398682(v=OCS.15)
ms:contentKeyID: 49294641
ms.date: 05/19/2016
...
Forces the back-end user database to clear its replication status with Active Directory. This causes the database to re-read all the user-related information stored in Active Directory-Domänendienste. Dieses Cmdlet wurde in Lync Server 2010 eingeführt.
