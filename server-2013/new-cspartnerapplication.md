...
ms:mtpsurl: https://technet.microsoft.com/de-de/library/JJ204628(v=OCS.15)
ms:contentKeyID: 49292992
ms.date: 05/19/2016
...
Creates a new partner application. A partner application is any application that Lync Server 2013 can directly exchange security tokens with, without having to go through a third-party security token server. Dieses Cmdlet wurde in Lync Server 2013 eingeführt.
...
**Lync Server-Systemsteuerung:** The functions carried out by the **New-CsPartnerApplication** cmdlet are not available in the Lync Server-Systemsteuerung.
