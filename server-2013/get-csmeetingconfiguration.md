...
ms:mtpsurl: https://technet.microsoft.com/de-de/library/Gg425875(v=OCS.15)
ms:contentKeyID: 49293721
ms.date: 05/19/2016
...
<td><p>Retrieves the meeting configuration data from the local replica of the zentralen Verwaltungsspeicher rather than from the zentralen Verwaltungsspeicher itself.</p></td>
</tr>
<tr class="even">
