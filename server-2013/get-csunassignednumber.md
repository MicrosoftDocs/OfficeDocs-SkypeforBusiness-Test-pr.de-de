...
ms:mtpsurl: https://technet.microsoft.com/de-de/library/Gg412792(v=OCS.15)
ms:contentKeyID: 49295025
ms.date: 05/19/2016
...
Retrieves one or more ranges of unassigned numbers and the routing rules that apply to those numbers. Dieses Cmdlet wurde in Lync Server 2010 eingeführt.
...
<td><p>Retrieves the unassigned number information from the local replica of the zentralen Verwaltungsspeicher, rather than the zentralen Verwaltungsspeicher itself.</p></td>
</tr>
</tbody>
</table>
