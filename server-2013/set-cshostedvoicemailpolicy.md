...
ms:mtpsurl: https://technet.microsoft.com/de-de/library/Gg412722(v=OCS.15)
ms:contentKeyID: 49294888
ms.date: 05/19/2016
...
Modifies a hosted voice mail policy. Dieses Cmdlet wurde in Lync Server 2010 eingeführt.
...
<td><p>Ermöglicht Ihnen, einen Verweis auf ein Objekt an das Cmdlet zu übergeben, statt individuelle Parameterwerte festzulegen. The object must be of type HostedVoicemailPolicy and can be retrieved by calling the <strong>Get-CsHostedVoicemailPolicy</strong> cmdlet.</p></td>
</tr>
<tr class="odd">
