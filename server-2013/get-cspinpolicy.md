...
ms:mtpsurl: https://technet.microsoft.com/de-de/library/Gg398262(v=OCS.15)
ms:contentKeyID: 49293366
ms.date: 05/19/2016
...
Returns information about the client personal identification number (PIN) policies configured for use in your organization. PIN authentication enables users to access Lync Server by providing a PIN instead of a user name and password. Dieses Cmdlet wurde in Lync Server 2010 eingeführt.
...
<td><p>Retrieves the PIN policy data from the local replica of the zentralen Verwaltungsspeicher rather than from the zentralen Verwaltungsspeicher itself.</p></td>
</tr>
</tbody>
</table>
