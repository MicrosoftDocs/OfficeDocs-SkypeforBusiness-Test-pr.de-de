...
ms:mtpsurl: https://technet.microsoft.com/de-de/library/Gg412957(v=OCS.15)
ms:contentKeyID: 49295305
ms.date: 05/19/2016
...
Retrieves a test scenario you can use to test phone numbers against specified routes and rules. Dieses Cmdlet wurde in Lync Server 2010 eingeführt.
...
<td><p>Retrieves the voice test configuration from the local replica of the zentralen Verwaltungsspeicher, rather than the zentralen Verwaltungsspeicher itself.</p></td>
</tr>
</tbody>
</table>
