...
ms:mtpsurl: https://technet.microsoft.com/de-de/library/Gg398224(v=OCS.15)
ms:contentKeyID: 49293278
ms.date: 05/19/2016
...
Retrieves one or more trunk configurations, which describe the settings for a trunking peer entity such as a public switched telephone network (PSTN) gateway, IP-private branch exchange (PBX), or Session Border Controller (SBC) at the service provider. Dieses Cmdlet wurde in Lync Server 2010 eingeführt.
...
<td><p>Retrieves the trunk configuration from the local replica of the zentralen Verwaltungsspeicher, rather than the zentralen Verwaltungsspeicher itself.</p></td>
</tr>
</tbody>
</table>
