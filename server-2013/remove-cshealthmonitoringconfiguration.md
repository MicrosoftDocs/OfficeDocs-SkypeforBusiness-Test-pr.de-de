...
ms:mtpsurl: https://technet.microsoft.com/de-de/library/Gg425794(v=OCS.15)
ms:contentKeyID: 49293557
ms.date: 05/19/2016
...
Removes an existing collection of health monitoring configuration settings. These settings enable administrators to run quality assurance tests without having to supply the user names and passwords for the required test accounts. Dieses Cmdlet wurde in Lync Server 2010 eingeführt.
