...
ms:mtpsurl: https://technet.microsoft.com/de-de/library/Gg398989(v=OCS.15)
ms:contentKeyID: 49295663
ms.date: 05/19/2016
...
Creates a new Response Group queue. With the Reaktionsgruppenanwendung, phone calls are put in a queue and callers are placed on hold until a Response Group agent is available to answer that call. Dieses Cmdlet wurde in Lync Server 2010 eingeführt.
