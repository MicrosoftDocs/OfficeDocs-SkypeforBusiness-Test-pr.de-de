...
ms:mtpsurl: https://technet.microsoft.com/de-de/library/Gg398655(v=OCS.15)
ms:contentKeyID: 49294588
ms.date: 05/19/2016
...
Retrieves endpoints for the Anwendungsdienst. Dieses Cmdlet wurde in Lync Server 2010 eingeführt.
...
This cmdlet retrieves one or more application contacts from Active Directory-Domänendienste. These objects are stored in Active Directory in the Application Contacts container of the RTC service.
