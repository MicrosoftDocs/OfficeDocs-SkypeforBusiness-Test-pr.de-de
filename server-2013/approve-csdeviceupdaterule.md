...
ms:mtpsurl: https://technet.microsoft.com/de-de/library/Gg398949(v=OCS.15)
ms:contentKeyID: 49295571
ms.date: 05/19/2016
...
Approves a device update rule that has been imported to the system. After a device update rule has been approved, the corresponding update will automatically be downloaded and installed by client devices affected by the update. Dieses Cmdlet wurde in Lync Server 2010 eingeführt.
