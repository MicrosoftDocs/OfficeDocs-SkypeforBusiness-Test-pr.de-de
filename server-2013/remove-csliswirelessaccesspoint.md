...
ms:mtpsurl: https://technet.microsoft.com/de-de/library/Gg398461(v=OCS.15)
ms:contentKeyID: 49294226
ms.date: 05/19/2016
...
Removes a Location Information Server (LIS) wireless access point (WAP). Dieses Cmdlet wurde in Lync Server 2010 eingeführt.
