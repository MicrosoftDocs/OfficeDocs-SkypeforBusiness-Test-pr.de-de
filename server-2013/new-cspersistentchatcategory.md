...
ms:mtpsurl: https://technet.microsoft.com/de-de/library/JJ204803(v=OCS.15)
ms:contentKeyID: 49293681
ms.date: 05/19/2016
...
**Lync Server-Systemsteuerung:** To create a new Persistent Chat category using the Lync Server-Systemsteuerung, click **Persistent Chat**, click **Category**, and then click **New**.
