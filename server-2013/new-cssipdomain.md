...
ms:mtpsurl: https://technet.microsoft.com/de-de/library/Gg425857(v=OCS.15)
ms:contentKeyID: 49293688
ms.date: 05/19/2016
...
Creates a new SIP domain for use in your organization. SIP domains are domains authorized to send and receive SIP traffic, and are used when assigning SIP addresses to users. Dieses Cmdlet wurde in Lync Server 2010 eingeführt.
