...
ms:mtpsurl: https://technet.microsoft.com/de-de/library/Gg413060(v=OCS.15)
ms:contentKeyID: 49295971
ms.date: 05/19/2016
...
Forces Lync Server replication services to send complete configuration data to the specified computers. This is done by deleting the replication status of the computers from the zentralen Verwaltungsspeicher. Dieses Cmdlet wurde in Lync Server 2010 eingeführt.
