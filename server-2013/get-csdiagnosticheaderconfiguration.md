...
ms:mtpsurl: https://technet.microsoft.com/de-de/library/Gg412774(v=OCS.15)
ms:contentKeyID: 49294985
ms.date: 05/19/2016
...
<td><p>Retrieves the diagnostic header configuration data from the local replica of the zentralen Verwaltungsspeicher rather than from the zentralen Verwaltungsspeicher itself.</p></td>
</tr>
</tbody>
</table>
