...
ms:mtpsurl: https://technet.microsoft.com/de-de/library/JJ945587(v=OCS.15)
ms:contentKeyID: 52056025
ms.date: 08/02/2014
...
Here is a list of terms and definitions that you might find useful as you read through this topic.
  ...
  - Organizational Unit – The Active Directory-Domänendienste organizational unit (OU).
...
![Registerkarte für die Erstellung von Benutzern](images/JJ945587.80d3c17b-7482-4818-8381-1eff8717d2fe(OCS.15).jpg "Registerkarte für die Erstellung von Benutzern")
...
8.  Select the **Voice Enabled** check box if you want to enable the test users for Enterprise-VoIP.
...
![Registerkarte für die Erstellung von Kontakten](images/JJ945587.7508726e-83e6-4878-8edd-114543d9af24(OCS.15).jpg "Registerkarte für die Erstellung von Kontakten")
...
![Registerkarte für die Erstellung von Verteilerlisten](images/JJ945587.0a1d681b-2aea-4724-90d8-efa8a526f600(OCS.15).jpg "Registerkarte für die Erstellung von Verteilerlisten")
...
When you click the Create Distribution Lists button, the tool queries Active Directory-Domänendienste to see if distribution lists matching the prefix and numbers already exist. The tool will create only the ones that do not already exist. When adding members to these newly created Distribution Lists, it will pick the users from the range specified on the User Creation tab.
...
![Registerkarte für die Konfiguration des Standortinformationsdiensts](images/JJ945587.52ea4e9e-d50a-4dc9-982b-31ee5ace4578(OCS.15).jpg "Registerkarte für die Konfiguration des Standortinformationsdiensts")
